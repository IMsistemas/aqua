 ...
 */
    ...
    app.controller('retencionVentasController', function($scope, $http, API_URL) {
        ...
        $scope.initLoad = function (pageNumber) {
            ...
            $http.get(API_URL + 'retencionVentas/getRetenciones?page=' + pageNumber + '&filter=' + JSON.stringify(filtros)).success(function(response){
        ...
        $scope.loadFormPage = function(id){
            ...
            $http.get(API_URL + 'retencionVentas/' + $scope.idretencion).success(function(response){
                ...
                $http.get(API_URL + 'retencionVentas/getRetencionesByVenta/' + $scope.idretencion).success(function(data){
        ...
        $scope.getCodigosRetencion = function () {
            ...
            if (tipo != 0) {
                $http.get(API_URL + 'retencionVentas/getCodigosRetencion/' + tipo).success(function(response){
                    var longitud = response.length;
                    var array_temp = [{ id: 0, name: '-- Códigos de Retención --' }];
                    for (var i = 0; i < longitud; i++) {
                        array_temp.push({id: response[i].iddetalleretencion, name: response[i].codigosri})
                    }
        ...
        $scope.save = function () {
            ...
            var url = API_URL + 'retencionVentas';
