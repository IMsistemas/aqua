    ...
    <div class="subcontainer1">
        <table style="width: 100%;">
            <tr>
                ...
                <td colspan="3"><?= $data[0]->lastnamepersona. ' ' . $data[0]->namepersona ?></td>
            </tr>
            <tr>
        ...
        <table class="table table-responsive table-striped table-hover table-condensed table-bordered" style="width: 90%;">
            ...
            <tbody>
                ...
                <?php
                    ...
                    foreach ($data[0]->cont_itemventa as $item) {
                        echo '<tr>';
                        echo '<td>' . ucwords(strtolower($item->cont_catalogoitem->nombreproducto)) . '</td>';
                        echo '<td style="text-align: right;">' . $item->preciototal . '</td>';
                        echo '</tr>';
                    }
            ...
            <tr>
                ...
                <th style="text-align: right; border-top: solid 1px;"><?= $data[0]->subtotalsinimpuestoventa ?></th>
            </tr>
            <tr>
                <th style="text-align: right;">Imponible <?= $data[0]->porcentaje ?> %: </th>
                <th style="text-align: right;"><?= $data[0]->ivacompra ?></th>
            </tr>
            <tr>
                <th style="text-align: right;">Total Factura USD $: </th>
                <th style="text-align: right;"><?= $data[0]->valortotalventa ?></th>
            </tr>
            </tfoot>
        </table>
    </div>
