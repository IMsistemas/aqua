...
<body>
 	<div class="col-xs-12 text-center">
		<h3><strong>Estado De Situación Financiera  </strong></h3>
	</div>
	<div class="col-xs-12 text-center">
	...
	<div class="col-xs-12">
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
		           <td><?= $estado_finaciero[2]["total_activo"] ?></td>
		           <td><?= $estado_finaciero[2]["total_pasivo"] ?></td>
		           <td><?= $estado_finaciero[2]["total_patrimonio"] ?></td>
		           <td><?= $estado_finaciero[2]["utilidad"] ?></td>
		           <td><?= $estado_finaciero[2]["balance"] ?></td>
		        </tr>
			</tbody>
		</table>
	</div>
