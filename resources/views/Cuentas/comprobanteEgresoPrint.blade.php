...
<body>
	...
	<div class="col-xs-12 text-right" style="margin-top: 20px;">
		<h4><strong>COMPROBANTE DE EGRESO No.  <?= $cobro[0]->idcuentasporpagar ?></strong></h4>
	</div>
	...
	<div class="col-xs-12" style="font-size: 12px !important;">
			...
			<tbody style="border-bottom: none;">
				...
				<tr >
					<td style="width: 80% !important;">
						<strong>A LA ORDEN DE:</strong> <span style="margin-top: 1px;"><?= strtoupper($cobro[0]->razonsocial) ?></span>
					</td>
		...
		<table class="table table-responsive table-striped table-hover table-condensed table-bordered" style="margin-top: -20px;">
			...
			<thead>
				<tr>
					<th style="width: 19%">ELABORADO</th>
					<th style="width: 17%">PRESIDENTE</th>
					<th style="width: 17%">GERENTE</th>
					<th style="width: 17%">CONTABILIZADO</th>
